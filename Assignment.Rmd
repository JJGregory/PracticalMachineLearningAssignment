...
I selected which of the two models to use for predicting the test set outcomes by compaing the OOB accuracies of the two models.
...
The random forest model had an accuracy of `r RF_OOB_confusion$overall[2] ` compared to the gradient boosted model's accuract of `r gbm_model_confusion$overall[2]`.

The random forest model was more accurate, so I chose to use it for my final predictions.
